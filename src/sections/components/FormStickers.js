...
import { Spinner, Button, Form, Item, Input, Thumbnail, Text, Icon, Card, CardItem, Body, Right } from 'native-base';
				...
				<CardItem cardBody>
					<Grid style={{ marginTop: 5 }}>
						<Col size={4} style={{ alignItems: 'center' }}>
							<Image
								style={{ height: hg + 200, width: screenWidth + 200 }}
								source={{
									uri:
										'http://www.gifde.com/gif/otros/decoracion/cargando-loading/cargando-loading-045.gif'
								}}
							/>
			...
			return (
				<Card>
					...
					<CardItem cardBody>
						<Grid style={{ marginTop: 5 }}>
							<Col>
								<Text>Algo salió mal : {this.props.error}</Text>
							</Col>
						</Grid>
					</CardItem>
				</Card>
					...
					<Card style={{ marginTop: 0, marginLeft: 0, marginRight: 0 }}>
						<CardItem style={{ backgroundColor: '#00B9D3' }}>
							...
							<Col size={4}>
								...
								>
									HAS CANJEADO {this.props.type.points} PUNTOS
								</Text>
							</Col>
						</CardItem>
					</Card>
			...
			<Card>
				...
				<CardItem>
					<Col style={{ alignItems: 'center' }}>
						...
						<Button onPress={this.consultarSticker} transparent Primary>
							<Icon
								type="MaterialCommunityIcons"
								name="qrcode-scan"
								style={{
				...
				<Text style={{ padding: 10, fontSize: 12 }}>
					{'Puntos: ' + this.props.type.points + ',  tipo: ' + this.props.type.color}
				</Text>
			</Card>
		);
	}
